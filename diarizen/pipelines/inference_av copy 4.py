...
class AV_DiariZenPipeline(DiariZenPipeline):
    ...
    def __init__(
        ...
        **kwargs
        ...
        # We manually implement __init__ to avoid the KeyError in the parent class
        # when loading configs that miss 'inference' or 'clustering' sections.
        ...
        if config_parse is not None:
            ...
            # [PATCH] Ensure keys exist before assignment
        ...
        # Initialize the Grandparent (SpeakerDiarizationPipeline) directly
        # bypassing DiariZenPipeline.__init__ to avoid the crash
    ...
    def get_av_segmentations(self, waveform: torch.Tensor, sample_rate: int, sess_name: str) -> SlidingWindowFeature:
        ...
        # Access 'step' directly from Inference object
